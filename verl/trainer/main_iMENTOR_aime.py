...
from verl.utils.reward_score import gsm8k, countdown, aime
from verl.trainer.ppo.ray_trainer_aime import RayPPOTrainer
...
class RNDReward(nn.Module):
    def __init__(self, input_size):
        super().__init__()
        self.emb = nn.Embedding(152064, 16)
...
class RewardManager():
    ...
    def __call__(self, data: DataProto):
        ...
        rnd_0, rnd_1 = self.rnd_reward(rnd_inputs)
        loss_rnd = rnd_0.mean()
...
class ValRewardManager():
    ...
    def __call__(self, data: DataProto, evaldict: defaultdict):
        """We will expand this function gradually based on the available datasets"""
        ...
        for i in range(len(data)):
            ...
            reward_tensor[i, valid_response_length - 1] = score
            evaldict[data_item.non_tensor_batch['ind']].append(score)
...
def main_task(config):
    ...
    from verl.trainer.ppo.ray_trainer_aime import ResourcePoolManager, Role
